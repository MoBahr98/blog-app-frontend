...
const allowedTags = BLOG_NAVBAR_DATA.map((item) => item.label);
  ...
  const generatePostIdeas = async () => {
    ...
    try {
      const aiResponse = await axiosInstance.post(
        ...
        {
          topics: "Technology, Science, Economy, Politics, Culture, Environment, Artificial Intelligence, Space Exploration, Renewable Energy, Psychology, Education, History, Innovation, Ethics, Health, Society, Art, Literature, Climate Change, Business, Future Trends",
        }
      );
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 my-4">
          <div className="form-card p-6 col-span-12 md:col-span-8">
            ...
            <div className="mt-4">
              ...
              <input
                placeholder="How AI is Transforming the Tech Industry"
            ...
            <div className="mt-3">
              <label className="text-xs font-medium text-slate-600">Tags
                <span className="block text-[11px] text-gray-500 mt-0.5">
                  Valid tags: {allowedTags.slice(1).join(", ")}
                </span>
              </label>
